...
public class BlogPostDAO {
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        BasicDBObject updateCommand = new BasicDBObject("$push", new BasicDBObject("comments", newComment));

        postsCollection.updateOne(updateQuery, updateCommand);
